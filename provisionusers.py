...
def main(argv):
    ...
    for s in serverlist["servers"]:
        serveridno = s["id"]
        url = fn.provision(host,authtoken,accountname,accountcomment,accountgroups,serveridno,passwordlength,passwordspecialchar,passwordnumberchar,passworduppercasechar,skey)
            ...
            if node.password != '':
                ...
                if result == "completed":
                    ...
                    if pw == ('' or None):
                        ...
                        node.url = fn.provision(host,authtoken,accountname,accountcomment,accountgroups,serveridno,passwordlength,passwordspecialchar,passwordnumberchar,passworduppercasechar,skey)
                    else:
                        node.password = pw
